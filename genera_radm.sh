...
echo ' Guarda'
cd ../10_storage
./radm2018.exe  > ../radm2_bio.log
#./RACM2016.exe  > ../racm2_bio.log
#./saprc99bio.exe > saprc_bio.log
dian=$[$dian+1]
done 
echo $outfile
/opt/librerias/intel/nco/4.6.7/bin/ncrcat -O wrfchemi.d01.RADM2.20* $outfile
rm /LUSTRE/OPERATIVO/modelos/WRF-CHEM/DOMAINS/ecacor/wrfprd/wrfchem*
mv $outfile /LUSTRE/OPERATIVO/modelos/WRF-CHEM/DOMAINS/ecacor/wrfprd
echo "DONE  Guarda_RADM"
cd ..
#sbatch genera_radm.sh
